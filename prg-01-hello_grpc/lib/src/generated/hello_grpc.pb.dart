...
class MyNumber extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyNumber', createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MyNumber copyWith(void Function(MyNumber) updates) => super.copyWith((message) => updates(message as MyNumber)) as MyNumber;
