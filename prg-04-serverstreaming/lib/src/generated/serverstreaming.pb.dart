...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'serverstreaming'), createEmptyInstance: create)
...
class Number extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Number', package: const $pb.PackageName(_omitMessageNames ? '' : 'serverstreaming'), createEmptyInstance: create)
